...
const TagIcon = ({ className }: IIcon) => (
    <div className={ className }>
        <svg version="1.1" id="tag" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
			...
			<g>
				<path d="M35.37,18.06c0.63,0,1.22-0.25,1.66-0.69c0.44-0.44,0.69-1.03,0.69-1.66c0-0.63-0.25-1.21-0.69-1.66
				...
				<path d="M40.84,10.24c-0.1-0.11-0.26-0.18-0.41-0.16L28.31,10.7c-0.14,0.01-0.26,0.06-0.35,0.16L13.89,24.93
				...
				<path d="M22.83,29.52c0.11,0.11,0.24,0.16,0.38,0.16c0.14,0,0.27-0.05,0.38-0.16L30,23.12c0.21-0.21,0.21-0.55,0-0.76
					c-0.21-0.21-0.55-0.21-0.76,0l-6.41,6.41C22.62,28.97,22.62,29.31,22.83,29.52z"/>
				<path d="M27.45,19.8c-0.21-0.21-0.55-0.21-0.76,0l-6.4,6.41c-0.21,0.21-0.21,0.55,0,0.76
